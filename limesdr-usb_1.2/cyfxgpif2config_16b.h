...
#ifndef _INCLUDED_CYFXGPIF2CONFIG_16B_
#define _INCLUDED_CYFXGPIF2CONFIG_16B_
#include "cyu3types.h"
#include "cyu3gpif.h"
 ...
 */
uint16_t CyFxGpifTransition_16b[]  = {
...
/* Summary
   ...
   waveform table. 
 */
CyU3PGpifWaveData CyFxGpifWavedata_16b[]  = {
 ...
 */
uint8_t CyFxGpifWavedataPosition_16b[]  = {
 ...
 */
const CyU3PGpifConfig_t CyFxGpifConfig_16b  = {
    (uint16_t)(sizeof(CyFxGpifWavedataPosition_16b)/sizeof(uint8_t)),
    CyFxGpifWavedata_16b,
    CyFxGpifWavedataPosition_16b,
    (uint16_t)(sizeof(CyFxGpifTransition_16b)/sizeof(uint16_t)),
    CyFxGpifTransition_16b,
    (uint16_t)(sizeof(CyFxGpifRegValue_16b)/sizeof(uint32_t)),
    CyFxGpifRegValue_16b
};
